...
def start(query, scholar_results, scholar_pages, proxy, dwn_dir='./', min_date=None, num_limit=None, num_limit_type=None, filter_jurnal_file=None, restrict=None, DOIs=None, SciHub_URL=None):
